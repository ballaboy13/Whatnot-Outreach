(function () {
   ...
   async function loadCityCoords() {
         try {
                 ...
                 console.log("Failed to load city coordinates", e);
         }
   }
   ...
   async function handleUpload(file) {
         ...
         try {
           ...
           var respText = await resp.text();
                 console.log("Server response:", respText.substring(0, 500));
                 var result;
                 try {
           ...
           showStatus("Success! Found " + result.newLocations.length + " addresses. Total: " + result.totalShipments + " shipments.", "success");
